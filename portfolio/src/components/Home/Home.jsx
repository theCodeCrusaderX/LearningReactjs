...
export default function Home() {
  ...
  return (
    ...
    >
      <div>
        <h2
          className={`text-3xl font-bold sm:text-5xl m-3 ${
        ...
        >
          ...
          <span
            className={`sm:block text-xl md:text-2xl mt-8 ${
              theme ? "text-white" : "text-black"
            }`}
          >
      ...
      <div className="md:w-2/4">
        <p className={`mt-10 ${theme ? "text-white" : "text-black"}`}>
          ...
          transforming ideas into functional, clean, and efficient digital
          solutions. My expertise spans the entire development lifecycle, from
          architecting scalable RESTful APIs using Node.js/Express and database
          management (PostgreSQL/Prisma or MongoDB), to delivering intuitive,
          responsive user experiences with React and modern UI frameworks. I
          thrive on solving complex problems and integrating emerging
          technologies, such as AI/Gemini API, to create highly valuable and
