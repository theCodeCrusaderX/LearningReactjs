  ...
  return (
    <div className="lg:flex justify-between gap-10 items-center">
      ...
      <div className="w-full lg:w-[40%]">
        <div>
          <p className="font-montserrat font-bold text-2xl m-4 ml-0">Front-End</p>
          <div className="flex gap-5 lg:w-3/4 flex-wrap">
            <div>
              <img
                ...
                className="h-16"
              />
              <p className="text-center font-roboto font-light text-lg">React</p>
            </div>
            <div>
              <img src="src/assets/js.png" alt="" className="h-16" />
              <p className="text-center font-roboto font-light text-lg">JavaScript</p>
            </div>
            <div>
              <img src="src/assets/redux.png" alt="" className="h-16" />
              <p className="text-center font-roboto font-light text-lg">Redux</p>
            </div>
            <div>
              <img src="src/assets/html.png" alt="" className="h-16" />
              <p className="text-center font-roboto font-light text-lg">HTML5</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-center font-roboto font-light text-lg">Bootstrap</p>
            </div>
          </div>
        </div>
        <div>
          <p className="font-montserrat font-bold text-2xl m-4 ml-0">Back-End</p>
          <div className="flex gap-5 w-3/4 flex-wrap">
            ...
            <div>
              ...
              <p className="text-center font-roboto font-light text-lg">Express</p>
            </div>
            <div>
              <img src="src/assets/appwrite.png" alt="" className="h-16" />
              <p className="text-center font-roboto font-light text-lg">appwrite</p>
            </div>

          </div>
        </div>
        <div>
          <p className="font-montserrat font-bold text-2xl m-4 ml-0">Databases </p>
          <div className="flex gap-5 w-3/4 flex-wrap">
            <div>
              <img
                ...
                className="h-16"
              />
              <p className="text-center font-roboto font-light text-lg">MongoDB</p>
            </div>
            <div>
              <img
                ...
                className="h-16"
              />
              <p className="text-center font-roboto font-light text-lg">Postgresql</p>
            </div>
          </div>
        </div>
        <div>
          <p className="font-montserrat font-bold text-2xl m-4 ml-0">Version Control & Deployment</p>
          <div className="flex gap-5 w-3/4 flex-wrap">
            <div>
              <img
            ...
            <div>
              ...
              <p className="text-center font-roboto font-light text-lg">GitHub</p>
            </div>
            <div>
              <img src="src/assets/vercel.png" alt="" className="h-16" />
              <p className="text-center font-roboto font-light text-lg">Vercel</p>
            </div>
            <div>
              <img src="src/assets/render.png" alt="" className="h-16" />
              <p className="text-center font-roboto font-light text-lg">Render</p>
            </div>
          </div>
        </div>
        <div>
          ...
          <div className="flex gap-5 w-3/4 flex-wrap">
            <div>
              <img
                src="src/assets/vs.webp"
                alt=""
                className="h-16"
              />
              <p className="text-center font-roboto font-light text-lg">VS Code</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-center font-roboto font-light text-lg">Postman</p>
            </div>
          </div>
        </div>
        <div>
          ...
          <div className="flex gap-5 w-3/4 flex-wrap">
            <div>
              <img
                ...
                className="h-16"
              />
              <p className="text-center font-roboto font-light text-lg">Figma</p>
            </div>
            <div>
              <img src="src/assets/canva.jpeg" alt="" className="h-16" />
              <p className="text-center font-roboto font-light text-lg">Canva</p>
            </div>
          </div>
        </div>
        <div>
          <p className="font-montserrat font-bold text-2xl m-4 ml-0">Soft Skills</p>
          <div className="flex gap-2 lg:gap-5 w-3/4 flex-wrap">
            <p className="font-nunito font-light text-lg">problem solving</p>
